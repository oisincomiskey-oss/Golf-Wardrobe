...
export const INITIAL_ORDERS: Order[] = [
  {
    ...
    paymentStatus: 'Paid',
    carrier: 'An Post',
    trackingNumber: 'AP948201948IE',
    paymentMethod: 'Credit Card (•••• 4242)'
  },
  {
    id: 'ord-1002',
    orderNumber: 'GW-84921',
    date: '2026-07-30',
    customer: {
      email: 'liam.oc@example.com',
      firstName: 'Liam',
      lastName: 'O’Connor',
      address: '8 Grand Canal Dock',
      city: 'Dublin 2',
      postcode: 'D02 P201',
      country: 'Ireland',
    ...
    subtotal: 97.00,
    discount: 0.00,
    shippingFee: 0.00, // Free over €75
    total: 97.00,
    status: 'Packed',
    paymentStatus: 'Paid',
    carrier: 'An Post',
    trackingNumber: 'AP948202001IE',
    paymentMethod: 'Apple Pay'
  },
  {
    id: 'ord-1003',
    orderNumber: 'GW-84922',
    date: '2026-08-01',
    customer: {
      email: 'james.montgomery@example.co.uk',
      firstName: 'James',
      lastName: 'Montgomery',
    ...
    subtotal: 65.00,
    discount: 0.00,
    shippingFee: 9.99, // UK 1 Headcover
    total: 74.99,
    status: 'Pending',
    paymentStatus: 'Paid',
    carrier: 'An Post',
  ...
  {
    id: 'ord-1004',
    orderNumber: 'GW-84923',
    date: '2026-08-02',
    customer: {
      email: 'michael.palmer@example.com',
      firstName: 'Michael',
      lastName: 'Palmer',
      address: '742 Cypress Point Drive',
      city: 'Pebble Beach',
      postcode: 'CA 93953',
      country: 'United States',
      phone: '+1 831 555 0192'
    },
    items: [
      {
        productId: 'prod-1',
      ...
      {
        productId: 'prod-3',
        name: 'The Golden Stag Fairway Wood Cover',
        price: 55.00,
        quantity: 1,
        image: 'https://images.unsplash.com/photo-1592919505780-303950717480?auto=format&fit=crop&q=80&w=1000',
        clubFit: '3 Wood'
    ...
    subtotal: 120.00,
    discount: 0.00,
    shippingFee: 22.99, // US 2 Headcovers
    total: 142.99,
    status: 'Pending',
    paymentStatus: 'Paid',
    carrier: 'DHL',
...
export const INITIAL_CUSTOMERS: CustomerUser[] = [
  {
    ...
    notes: 'VIP customer. Prefers Florentine leather products.'
  },
  {
    id: 'cust-2',
    email: 'liam.oc@example.com',
    ...
    notes: 'Enquired about custom Irish Shamrock embroidery.'
  }
];
